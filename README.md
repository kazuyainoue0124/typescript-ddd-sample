...
## プレゼンテーションとは
- プレゼンテーション層はアプリケーションのインターフェース部分、MVCにおけるControllerやViewに相当する
- 「HTML」「REST API」「CLI」などのインターフェースを提供する
- DDDにおいてプレゼンテーション層はアプリケーションサービスのクライアントとみなされる。ユーザーからの入力をアプリケーションサービスに渡す
- ドメイン層やアプリケーション層から投げられた例外をキャッチするのもプレゼンテーションの役割
- プレゼンテーション層は特定の技術やフレームワークに依存することが許可される。この依存をドメイン層やアプリケーション層に持ち込まないことが重要
